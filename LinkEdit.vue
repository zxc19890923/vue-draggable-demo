<template>
  <div>
    ...
    <div class="editTagText">
      <span class="editTagLabel">链接地址</span>
    </div>
    <div class="editTag">
      <Input type="text" v-model="childItemInfo.text" :maxlength="100" @on-change="requireStateChange"/>
    </div>
    <div class="editTagText">
      <span class="editTagLabel">链接说明</span>
    </div>
    <div class="editTag">
      <span class="editTagNumber">6/30</span>
      <Input type="text" v-model="childItemInfo.title" :maxlength="30" @on-change="requireStateChange"/>
    </div>
    <div class="editTagText">
